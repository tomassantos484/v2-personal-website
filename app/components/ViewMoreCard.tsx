...
export default function ViewMoreCard({ useProjectsPage = false }) {
  return (
    <div
    ...
    >
      <Link 
        href={useProjectsPage ? "/projects" : "https://github.com/tomassantos484"}
        target={useProjectsPage ? "_self" : "_blank"} 
        rel={useProjectsPage ? "" : "noopener noreferrer"}
      ...
      >
        ...
        <Icon 
          icon={useProjectsPage ? "mdi:file-document-multiple" : "mdi:github"}
